...
class Board:
    ...
    # поле бота
    _SYMBOL = [['_', '.',  # свободное поле / была стрельба
                '_', '.',  # бордюр корабля / была стрельба
                '_', 'X'],  # корабль / была стрельба
               # поле игрока
               ['_', '.',  # свободное поле / была стрельба
                '_', '.',  # бордюр корабля / была стрельба
                '■', 'x']]  # корабль / была стрельба
    ...
    def get_legend(self):
        ...
        s = '\n Мое поле:' + '  ' * (self.size-1) + 'Ваше поле:\n' + '  '
